...
const DarkPatternPage = () => {
  ...
  return (
    <main className=' w-full bg-[#0a051d] absolute top-0 left-0'>
      ...
      <p className='text-2xl font-medium text-center px-28 mt-14 '>Welcome to our Dark Pattern Directory, where we highlight websites known for employing deceptive design tactics. Stay informed and protect yourself from manipulative practices by exploring the list below.</p>
        ...
        <div className=' flex flex-wrap gap-20 justify-center py-20'>
          ...
          {
            data.map((p,i)=>(
              <div key={i} className='h-[60vh] w-80 rounded-xl overflow-hidden'>
