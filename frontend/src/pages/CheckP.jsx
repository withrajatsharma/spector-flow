  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:4000/api/user/geminires",
        formData,
        {
          headers: {
        ...
        toast.custom(
          (t) => (
            ...
            >
              ...
              >
                <button className="w-full border border-transparent rounded-none rounded-r-lg p-4 flex items-center justify-center text-lg font-medium mx-2  focus:outline-none text-gray-300">
                  Close
                </button>
              </div>
            </div>
        ...
        <div className=" w-1/2  ">
          <form onSubmit={handleSubmit} class="max-w-sm mx-auto -mt-20">
            ...
            <input
              ...
              name="file"
              id="file-input"
              class="block w-full border mt-2 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 disabled:opacity-50 disabled:pointer-events-none bg-slate-900 border-gray-700 text-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-600
 file:border-0
    file:me-4
    file:py-3 file:px-4
    file:bg-gray-700 file:text-gray-400"
            ...
            <div className="flex items-center  justify-between mt-10">
              ...
              <Link
                to={"/userd"}
                class="text-white focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center bg-purple-600 hover:bg-purple-700 focus:ring-purple-800"
              >
                give feedback
              </Link>
            </div>
